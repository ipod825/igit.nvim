...
describe("dirname", function()
    it("Returns parent for file",
       function() assert.are.equal(path.dirname('a/b'), 'a') end)

    it("Returns directory for directory",
       function() assert.are.equal(path.dirname('a/b/'), 'a/b') end)
end)

describe("basename", function()
    it("Works with file",
       function() assert.are.equal(path.basename('a/b'), 'b') end)
...
describe("path_join", function()
    it("joins the paths",
       function() assert.are.equal(path.path_join('a', 'b'), 'a/b') end)
end)
