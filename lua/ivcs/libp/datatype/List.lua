...
function M:to_iter()
	return require("ivcs.libp.datatype.Iterator")({ next_fn = next, invariant = self })
end

function M:map(...)
	return require("ivcs.libp.datatype.Iterator")({ next_fn = next, invariant = self }):map(...)
end

function M:filter(...)
	return require("ivcs.libp.datatype.Iterator")({ next_fn = next, invariant = self }):filter(...)
end
