...
M.VisualRowStub = function(...)
	...
	local stub = visual_rows_stub or require("luassert.stub")(require("igit.libp.vimfn"), "visual_rows")
	stub.by_default.returns(...)
	return stub
end

function M.stub_visual_rows(...)
	M.visual_rows_stub = M.visual_rows_stub or require("luassert.stub")(require("igit.libp.vimfn"), "visual_rows")
