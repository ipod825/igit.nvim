...
function M:setup(opts)
	...
	M.log = require("igit.vcs.git.page.Log")(opts.log)
	M.branch = require("igit.vcs.git.page.Branch")(opts.branch)
	M.status = require("igit.vcs.git.page.Status")(opts.status)
